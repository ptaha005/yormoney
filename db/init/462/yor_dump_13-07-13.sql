...
INSERT INTO `account_type` VALUES (1,'Checking account'),(2,'Current account'),(3,'Personal account'),(4,'Transaction deposit'),(5,'Demat account'),(6,'Individual Savings Account'),(7,'Time deposit / certificate of deposit'),(8,'Tax-Exempt Special Savings Account'),(9,'Tax-Free Savings Account'),(10,'Money market account'),(11,'Loan account'),(12,'Joint account'),(13,'Low-cost account'),(14,'Nostro and vostro accounts'),(15,'Numbered bank account'),(16,'Negotiable Order of Withdrawal account');
...
INSERT INTO `bank` VALUES (1,'Bank of America'),(2,'Bank of the West'),(3,'Branch Banking and Trust Company'),(4,'Chase Bank USA'),(5,'Citibank'),(6,'Comerica Bank'),(7,'Countrywide Bank'),(8,'E*TRADE Bank'),(9,'FIA Card Services'),(10,'Fifth Third Band'),(11,'HSBC Bank USA'),(12,'ING Bank'),(13,'JPMorgan Chase Bank'),(14,'Keybank'),(15,'LaSalle Bank'),(16,'M&I Marshall and Ilsley Bank'),(17,'Manufacturers and Traders Trust Company'),(18,'Merrill Lynch Bank'),(19,'National City Bank'),(20,'North Fork Bank'),(21,'PNC Bank'),(22,'Regions Bank'),(23,'Sovereign Bank'),(24,'State Street Bank and Trust Company'),(25,'SunTrust Bank'),(26,'The Bank of New York'),(27,'The Northern Trust Company'),(28,'U.S. Bank'),(29,'Union Bank of California'),(30,'Wachovia Bank'),(31,'Washington Mutual Bank'),(32,'Wells Fargo Bank'),(33,'World Saving Bank');
...
INSERT INTO `category` VALUES (1,'Home'),(2,'Car'),(3,'	\r\nPublic service'),(4,'Other');
...
CREATE TABLE `email` (
  ...
  `company_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_dv13axkvqflv39dyvksvy40p6` (`company_id`),
  CONSTRAINT `FK_dv13axkvqflv39dyvksvy40p6` FOREIGN KEY (`company_id`) REFERENCES `company` (`id`)
...
INSERT INTO `expenditure_type` VALUES (1,'Light',1),(2,'Petrol',2),(3,'Oil',2),(4,'Odor',2),(5,'Internet service ',3),(6,'Water',3),(7,'Kindergarten',4),(8,'Cigarettes',4);
...
INSERT INTO `folder` VALUES (6,'Empty folder',1),(8,'Page',1),(9,'Image',1),(10,'File type pdf',1);
...
INSERT INTO `manual` VALUES (1,'You are reading a manual on page \"Register\"','s1',1),(2,'You are reading a manual on \"Welcome\"','s2',2),(3,'You are reading a manual on page \"Register step 2\"','s3',3),(4,'You are reading a manual on page \"Bankaccounts\"','s4',4),(5,'You are reading a manual on page \"Income\"','s5',5),(6,'You are reading a manual on page \"Expenditure\"','s6',6),(7,'You are reading a manual on page \"Event\"','s7',7),(8,'You are reading a manual on page \"Summary\"','s8',8);
...
INSERT INTO `relationship` VALUES (1,'Son'),(2,'Mother'),(3,'Father'),(4,'Friend'),(5,'Sister'),(6,'Brother');
...
INSERT INTO `transaction` VALUES (1,'2013-07-22','insurance',1,NULL,200,'Insurance'),(2,'2013-07-23','insurance',1,NULL,200,'Insurance'),(3,'2013-07-24','insurance',1,NULL,200,'Insurance'),(4,'2013-07-25','insurance',1,NULL,200,'Insurance'),(5,'2013-07-22','insurance',1,NULL,200,'Insurance'),(6,'2013-07-31','insurance',1,NULL,200,'Insurance');
...
INSERT INTO `user` VALUES (1,'2222','test@test.ru','yormoney','9108dcca5861fbb4ecc43f8fa71ea34b','0000-0000-0000-0000','test','test','sfsf',2,'2002-02-02','test',3,'register1');
...
INSERT INTO `video` VALUES (1,'Register video','http://www.youtube.com/embed/XGSy3_Czz8k',1,NULL,NULL),(2,'Welcome video','http://www.youtube.com/embed/XGSy3_Czz8k',2,NULL,NULL),(3,'Register step 2 video','http://www.youtube.com/embed/XGSy3_Czz8k',3,NULL,NULL),(4,'Bankaccount video','http://www.youtube.com/embed/XGSy3_Czz8k',4,NULL,NULL),(5,'Income video','http://www.youtube.com/embed/XGSy3_Czz8k',5,NULL,NULL),(6,'Expenditure video','http://www.youtube.com/embed/XGSy3_Czz8k',6,NULL,NULL),(7,'Event video','http://www.youtube.com/embed/XGSy3_Czz8k',7,NULL,NULL),(8,'Summary video','http://www.youtube.com/embed/XGSy3_Czz8k',8,NULL,NULL);
...
-- Dump completed on 2013-07-31 16:46:37
